...
export const alertVariants = tv({
	base: 'mt-2 text-sm rounded-lg relative w-full border px-4 py-3 text-sm [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground [&>svg~*]:pl-7',
	variants: {
		variant: {
	...
	compoundVariants: [
		...
		},
		{
			variant: 'outline',
			color: 'blue',
			class: 'border border-blue-200 text-gray-800'
		},
		{
			variant: 'outline',
			color: 'teal',
			class: 'border border-teal-200 text-teal-800'
		},
		{
			variant: 'outline',
			color: 'red',
			class: 'border border-red-200 text-red-800'
		},
		{
			variant: 'outline',
			color: 'yellow',
			class: 'border border-yellow-200 text-yellow-800'
		},
		{
			variant: 'outline',
			dark: true,
