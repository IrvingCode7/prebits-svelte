...
const buttonVariants = tv({
	base: 'inline-flex items-center gap-x-2 text-sm font-semibold rounded-md border disabled:opacity-50 disabled:pointer-events-none',
	variants: {
		variant: {
			solid: 'border-transparent text-white',
			outline:
				'dark:border-neutral-700 dark:text-neutral-400 dark:hover:text-blue-500 dark:hover:border-blue-600',
	...
	compoundVariants: [
		...
		},
		{
			...
			color: 'gray',
			class:
				'font-medium border-gray-200 bg-white text-gray-500 shadow-sm hover:bg-gray-50 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:hover:bg-neutral-800'
		},
		{
			variant: 'white',
			color: 'blue',
			class:
				'font-medium border-gray-200 bg-white text-blue-600 shadow-sm hover:bg-gray-50 dark:bg-neutral-900 dark:border-neutral-700 dark:text-blue-500 dark:hover:bg-neutral-800'
		},
		{
			variant: 'white',
			color: 'teal',
			class:
				'font-medium border-gray-200 bg-white text-teal-500 shadow-sm hover:bg-gray-50 dark:bg-neutral-900 dark:border-neutral-700 dark:hover:bg-neutral-800'
		},
		{
			variant: 'white',
			color: 'red',
			class:
				'font-medium border-gray-200 bg-white text-red-500 shadow-sm hover:bg-gray-50 dark:bg-neutral-900 dark:border-neutral-700 dark:hover:bg-neutral-800'
		},
		{
			variant: 'white',
			color: 'yellow',
			class:
				'font-medium border-gray-200 bg-white text-yellow-500 shadow-sm hover:bg-gray-50 dark:bg-neutral-900 dark:border-neutral-700 dark:hover:bg-neutral-800'
		},
		{
			variant: 'link',
			color: 'gray',
